...
if ( $story->shares->count > 0 && $efbl_skin_values['design']['show_shares'] ) {
    ?>
        ...
        <div class="efbl-reacted-item"><i class="icon icon-esf-share"></i><?php 
...
if ( $efbl_skin_values['design']['show_feed_share_button'] ) {
    ...
    ?></button>
        <div class="esf-social-share">
          <button>
            <a class="efbl_facebook" href="https://www.facebook.com/sharer/sharer.php?u=<?php 
    echo  $story_link ;
    ?>" target="<?php 
    echo  $link_target ;
    ?>">
          ...
          <button>
            <a class="efbl_twitter" href="https://twitter.com/intent/tweet?text=<?php 
    echo  $story_link ;
    ?>" target="<?php 
    echo  $link_target ;
    ?>">
          ...
          <button>
            <a class="efbl_linked_in" href="https://www.linkedin.com/shareArticle?mini=true&url=<?php 
    echo  $story_link ;
    ?>" target="<?php 
    echo  $link_target ;
    ?>">
