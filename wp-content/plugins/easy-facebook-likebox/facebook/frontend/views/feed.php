...
if ( !$json_decoded->error ) {
    ...
    if ( $efbl_skin_values['design']['show_header'] ) {
        ...
        if ( $esf_theme_header_url = locate_template( array( 'easy-facebook-likebox/html-feed-header.php' ) ) ) {
...
<?php 
        foreach ( $fbData as $story ) {
            ...
            if ( $efbl_templateurl = locate_template( array( 'easy-facebook-likebox/templates/template-' . $layout . '.php' ) ) ) {
	...
	<?php 
        ...
        if ( $esf_theme_footer_url = locate_template( array( 'easy-facebook-likebox/facebook/frontend/views/html-feed-footer.php' ) ) ) {
