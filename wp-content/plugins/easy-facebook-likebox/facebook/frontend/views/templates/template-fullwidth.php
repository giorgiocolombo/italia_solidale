    ...
    if ( $story->attachments->data[0]->media->image->src ) {
        ...
        if ( efl_fs()->is_free_plan() || efl_fs()->is_plan( 'instagram_premium', true ) ) {
            ...
            if ( $feed_type == 'added_video' || $feed_attachment_type == 'video_inline' ) {
                ?>
                    <i class="icon icon-esf-clone icon-esf-video-camera" aria-hidden="true"></i>
                  <?php 
            }
...
if ( $feed_type == 'shared_story' ) {
    ...
    if ( $shared_src ) {
        ...
        if ( efl_fs()->is_free_plan() || efl_fs()->is_plan( 'instagram_premium', true ) ) {
            ...
            ?>" class="efbl_link_image" re="nofollow" target="<?php 
            echo  $link_target ;
            ?>"><img alt="<?php 
            echo  $story->name ;
            ?>" src="<?php 
    ...
    if ( $filter == 'albums' ) {
        ...
        ?>
                      ...
                      <div class="efbl-total-album-images">
                        <span class="efbl_albums_icon"><i class="icon icon-esf-picture-o" aria-hidden="true"></i></span> 
