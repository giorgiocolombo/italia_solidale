...
?><a class="esf-small-btn" href="<?php 
echo  $ESF_Admin->esf_get_plugin_install_link( 'wpoptin' ) ;
?>"><?php 
esc_html_e( "Install now free", 'easy-facebook-likebox' );
?></a></li>
...
?></p>
    <form class="efbl_popup_settings" name="efbl_popup_settings" type="post">   
        <div class="row checkbox-row efbl_enable_popup">
            <input class="efbl_options" data-option="efbl_enable_popup" <?php 
checked( 1, $this->options( 'efbl_enable_popup' ), true );
?>  type="checkbox" name="efbl_settings_display_options[efbl_enable_popup]" id="efbl_enable_popup" />
...
?></label>
        ...
        <div class="row">
            <div class="input-field col s12">
                <input name="efbl_settings_display_options[efbl_popup_interval]" class="efbl_input_options" value="<?php 
echo  $this->options( 'efbl_popup_interval' ) ;
?>" id="efbl_popup_interval" type="number">
                <label for="efbl_popup_interval" class=""><?php 
...
?></span>
        ...
        <div class="row">
            <div class="input-field col s12">
                <input name="efbl_settings_display_options[efbl_popup_width]" class="efbl_input_options" min="0" value="<?php 
echo  $this->options( 'efbl_popup_width' ) ;
?>" id="efbl_popup_width" type="number">
                <label for="efbl_popup_width" class=""><?php 
...
?></span>
        ...
        <div class="row">
            <div class="input-field col s12">
                <input name="efbl_settings_display_options[efbl_popup_height]" class="efbl_input_options" min="0" value="<?php 
echo  $this->options( 'efbl_popup_height' ) ;
?>" id="efbl_popup_height" type="number">
                <label for="efbl_popup_height" class=""><?php 
...
?></span>
        ...
        <div class="row">
            <div class="input-field col s12">
                <textarea id="efbl_popup_shortcode" class="materialize-textarea" class="efbl_input_options" name="efbl_settings_display_options[efbl_popup_shortcode]"><?php 
...
?>
                    ...
                    <div class="row checkbox-row efbl_enable_home_only">
                        ...
                        <input class="efbl_options" data-option="efbl_enable_home_only"  <?php 
checked( 1, $this->options( 'efbl_enable_home_only' ), true );
?>  type="checkbox" name="efbl_settings_display_options[efbl_enable_home_only]" id="efbl_enable_home_only" />
...
?></label>
                    ...
                    <div class="row checkbox-row efbl_enable_if_login">
                        <input class="efbl_options" data-option="efbl_enable_if_login" <?php 
checked( 1, $this->options( 'efbl_enable_if_login' ), true );
?>  type="checkbox" name="efbl_settings_display_options[efbl_enable_if_login]" id="efbl_enable_if_login" />
...
?></label>
                    ...
                    <div class="row checkbox-row efbl_enable_if_not_login">
                        <input class="efbl_options" data-option="efbl_enable_if_not_login" <?php 
checked( 1, $this->options( 'efbl_enable_if_not_login' ), true );
?>  type="checkbox" name="efbl_settings_display_options[efbl_enable_if_not_login]" id="efbl_enable_if_not_login" />
...
?></label>
                    ...
                    <div class="row checkbox-row efbl_do_not_show_again">
                        <input class="efbl_options" data-option="efbl_do_not_show_again" <?php 
checked( 1, $this->options( 'efbl_do_not_show_again' ), true );
?>  type="checkbox" name="efbl_settings_display_options[efbl_do_not_show_again]" id="efbl_do_not_show_again" />
...
?></label>
                    ...
                    <div class="row checkbox-row efbl_do_not_show_on_mobile">
                        <input class="efbl_options" data-option="efbl_do_not_show_on_mobile" <?php 
checked( 1, $this->options( 'efbl_do_not_show_on_mobile' ), true );
?>  type="checkbox" name="efbl_settings_display_options[efbl_do_not_show_on_mobile]" id="efbl_do_not_show_on_mobile" />
