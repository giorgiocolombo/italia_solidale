    ...
    <div class="row">
        <div class="efbl-tabs-vertical">
            <div class="col s2 efbl_si_tabs_name_holder">
                <ul class="tabs">
                    <li class="tab">
                        <a class="active" href="#efbl-feed-use"><?php 
...
if ( isset( $fta_settings['plugins']['facebook']['approved_pages'] ) && !empty($fta_settings['plugins']['facebook']['approved_pages']) ) {
    ...
    ?></p>
                                <div class="efbl-shortcode-holder">
                                    <blockquote class="efbl-shortcode-block">[efb_feed fanpage_id="<?php 
    echo  $default_page_id ;
    ?>" skin_id="<?php 
    echo  efbl_default_skin_id() ;
    ?>" words_limit="25"] </blockquote> 

                                    <a class="btn waves-effect efbl_copy_shortcode waves-light tooltipped" data-position="right" data-delay="50" data-tooltip="<?php 
    esc_html_e( "Copy", 'easy-facebook-likebox' );
    ?>" data-clipboard-text='[efb_feed fanpage_id="<?php 
    echo  $default_page_id ;
    ?>" skin_id="<?php 
    echo  efbl_default_skin_id() ;
    ?>" words_limit="25"]' href="javascript:void(0);"><i class="material-icons right">content_copy</i> </a>
                                </div>    
    ...
    ?>  
                                ...
                                <blockquote class="efbl-red-notice"><?php 
...
?></label>
                                ...
                                <div class="input-field col s12 efbl_fields">
                                    ...
                                    <label for="efbl_access_token" class=""><?php 
...
?>
                                    ...
                                    <div class="input-field col s12 efbl_fields">
                                        ...
                                        <label for="ef_other_spage_free" class=""><?php 
...
?></label>
                                    ...
                                    <div class="input-field col s6 efbl_fields" style="padding-right: 10px;">
                                        ...
                                        <label for="efbl_post_limit" class=""><?php 
...
?></label>
                                    ...
                                    <div class="input-field col s6 efbl_fields">
                                        ...
                                        <input id="efbl_caption_words" value="25" type="number" min="1">
                                        <label for="efbl_caption_words" class=""><?php 
...
?></label>
                                    ...
                                    <div class="input-field col s6 efbl_fields" style="margin-top: 22px; padding-right: 10px;">
                                        ...
                                        <label for="efbl_cache_unit" class=""><?php 
...
?></option>
                                            <option selected value="days"><?php 
...
?></label>
                                    ...
                                    <input type="submit" class="btn  efbl_shortcode_submit" value="<?php 
...
?></p>
                                    ...
                                    <a class="btn waves-effect efbl_copy_shortcode efbl_shortcode_generated_final waves-light tooltipped" data-position="bottom" data-delay="50" data-tooltip="<?php 
esc_html_e( "Copy", 'easy-facebook-likebox' );
?>"  href="javascript:void(0);"><i class="material-icons center">content_copy</i> </a>
                                </div>  
...
?></span>
                                ...
                                <div class="collapsible-body"><p><?php 
...
?></p>
                                    ...
                                    <div class="efbl-shortcode-holder">
                                        <blockquote class="efbl-shortcode-block">[efb_likebox fanpage_url=<?php 
echo  $default_page_id ;
?> responsive=1]</blockquote> 
                                        <a class="btn waves-effect efbl_copy_shortcode waves-light tooltipped" data-position="right" data-delay="50" data-tooltip="<?php 
esc_html_e( "Copy", 'easy-facebook-likebox' );
?>" data-clipboard-text="[efb_likebox fanpage_url=<?php 
echo  $default_page_id ;
?> responsive=1]" href="javascript:void(0);"><i class="material-icons right">content_copy</i> </a>
                                     </div>    
                                     <?php 
...
?></h5>
                                        <div class="input-field col s12 efbl_fields">
                                            ...
                                            <label for="efbl_like_box_url" class=""><?php 
...
?>                   
                                        ...
                                        <div class="input-field col s6 efbl_fields" style="padding-right: 10px;">
                                            ...
                                            <label for="efbl_like_box_app_id" class=""><?php 
...
?></label>
                                        ...
                                        <div class="input-field col s6 efbl_fields">
                                            ...
                                            <label for="efbl_like_box_width" class=""><?php 
...
?></label>
                                        ...
                                        <div class="input-field col s6 efbl_fields" style="margin-top: 22px; padding-right: 10px;">
                                            ...
                                            <label for="efbl_like_box_height" class=""><?php 
...
?></label>
                                ...
                                <input type="submit" class="btn efbl_likebox_shortcode_submit" value="<?php 
esc_html_e( "Generate", 'easy-facebook-likebox' );
?>" />
                            </form>
...
?></p>
                                ...
                                <a class="btn waves-effect efbl_likebox_copy_shortcode efbl_likebox_shortcode_generated_final waves-light tooltipped" data-position="right" data-delay="50" data-tooltip="<?php 
esc_html_e( "Copy", 'easy-facebook-likebox' );
?>"  href="javascript:void(0);"><i class="material-icons center">content_copy</i> </a>
                            </div>  
