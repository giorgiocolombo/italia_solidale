...
<div id="efbl-authentication" class="col efbl_tab_c s12 slideLeft active">
    ...
    <a class="waves-effect waves-light efbl_authentication_btn btn" href="<?php echo esc_url( $authenticate_url ) ?>"><img class="efb_icon left" src="<?php echo EFBL_PLUGIN_URL ?>/admin/assets/images/facebook-icon.png"/><?php esc_html_e("Connect My Facebook Pages", 'easy-facebook-likebox');?></a>
        ...
        <div class="efbl_all_pages col s12"> 
            ...
            <?php if( isset($fta_settings['plugins']['facebook']['approved_pages']) && !empty( $fta_settings['plugins']['facebook']['approved_pages'] ) ){   ?>
             ...
             <ul class="collection with-header"> 
                ...
                <a href="#fta-remove-at" class="modal-trigger fta-remove-at-btn tooltipped" data-position="left" data-delay="50" data-tooltip="<?php esc_html_e("Delete Access Token", 'easy-facebook-likebox');?>">
            ...
            ?>
               ...
               <li class="collection-item avatar li-<?php echo $efbl_page['id'] ?>">
                ...
                <a href="<?php echo esc_url( 'https://web.facebook.com/'.$efbl_page['id'].'') ?>" target="_blank">
                    <img src="<?php echo efbl_get_page_logo($efbl_page['id']); ?>" alt="" class="circle">
                </a>
                ...
                <p>
                    ...
                    <?php if( $efbl_page['category'] ){ echo  $efbl_page['category'];  } ?>
                    <br> 
                    <?php if( $efbl_username_label ){ echo  $efbl_username_label;  } ?> 

                    <?php if( $efbl_username ){ echo  $efbl_username; ?>

                        <i class="material-icons efbl_copy_id tooltipped" data-position="right" data-clipboard-text="<?php echo $efbl_username ?>" data-delay="100" data-tooltip="<?php esc_html_e("Copy", 'easy-facebook-likebox');?>">content_copy</i>
                    <?php } ?>  
                </p>
