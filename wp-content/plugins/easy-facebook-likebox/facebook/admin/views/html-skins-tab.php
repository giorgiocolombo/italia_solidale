...
?></a></p>
    ...
    <a class="btn waves-effect efbl_create_skin waves-light" href="javascript:void(0);">
        <?php 
...
?> <i class="material-icons left">add_circle_outline</i></a>
        ...
        <div class="efbl_new_skin col s12"> 
            <form name="efbl_new_skin_details" id="efbl_new_skin_details">
                <a class="waves-effect waves-light efbl_show_all_skins btn" href="javascript:void(0);"><?php 
...
?> <i class="material-icons left">list</i></a>
                <div class="input-field">
                    ...
                    <label for="efbl_skin_title" class=""><?php 
...
?></label>
                ...
                <div class="input-field">
                    ...
                    <label for="efbl_skin_description" class=""><?php 
...
?>
                ...
                <label for="efbl_selected_layout" class=""><?php 
...
?>
                ...
                <label for="efbl_account_selected" class=""><?php 
...
?></label>
            ...
            <i class="btn waves-effect create_new_skin_fb_wrap waves-light waves-input-wrapper">
                <input type="submit" class="create_new_skin_fb" name="create_new_skin_fb" value="<?php 
...
if ( isset( $efbl_skins ) ) {
    foreach ( $efbl_skins as $efbl_skin ) {
        ...
        ?></span><i class="material-icons right">edit</i></a>
                                ...
                                <a class="btn waves-effect right efbl_skin_delete_confrim waves-light" data-skin_id="<?php 
        echo  $efbl_skin['ID'] ;
        ?>" href="javascript:void(0);"><span><?php 
        esc_html_e( "Delete", 'easy-facebook-likebox' );
        ?></span><i class="material-icons right">delete_forever</i></a>

                                <a class="btn waves-effect efbl_copy_skin_id waves-light"  data-clipboard-text="<?php 
        echo  $efbl_skin['ID'] ;
...
if ( efl_fs()->is_free_plan() || efl_fs()->is_plan( 'instagram_premium', true ) ) {
    ?>
            ...
            <div class="card col efbl_single_skin efbl_single_skin_free s3">
                ...
                <div class="card-image waves-effect waves-block waves-light">
                    <a class=" modal-trigger" href="#efbl-free-grid-upgrade"> <img class="" src="<?php 
    echo  FTA_PLUGIN_URL ;
    ?>admin/assets/images/skin-placeholder.jpg"> </a>
                </div>
                <div class="card-content">
                    <a class=" modal-trigger" href="#efbl-free-grid-upgrade"> <span class="card-title  grey-text text-darken-4"><?php 
    ...
    echo  $efbl_redirect_class ;
    ?> modal-trigger" href="#efbl-free-grid-upgrade"><span><?php 
    esc_html_e( "Edit", 'easy-facebook-likebox' );
    ?></span><i class="material-icons right">edit</i></a>

                    <a class="btn waves-effect right efbl_skin_delete_free waves-light modal-trigger" href="#efbl-free-grid-upgrade"><span><?php 
    esc_html_e( "Delete", 'easy-facebook-likebox' );
    ?></span><i class="material-icons right">delete_forever</i></a>

                    <a class="btn waves-effect efbl_copy_skin_id modal-trigger  waves-light" href="#efbl-free-grid-upgrade"><?php 
    esc_html_e( "Copy Skin ID", 'easy-facebook-likebox' );
    ?><i class="material-icons right">content_copy</i></span> </a>
                </div>
    ...
    ?></p>
            ...
            <div class="card col efbl_single_skin efbl_single_skin_free s3">
                ...
                <div class="card-image waves-effect waves-block waves-light">
                    <a class=" modal-trigger" href="#efbl-free-masonry-upgrade"> <img class="" src="<?php 
    echo  FTA_PLUGIN_URL ;
    ?>admin/assets/images/skin-placeholder.jpg"> </a>
                </div>
                <div class="card-content">
                    <a class=" modal-trigger" href="#efbl-free-masonry-upgrade"> <span class="card-title  grey-text text-darken-4"><?php 
    ...
    ?>
                    ...
                    <a class="btn waves-effect  waves-light efbl_skin_redirect_free <?php 
    echo  $efbl_redirect_class ;
    ?> modal-trigger" href="#efbl-free-masonry-upgrade"><span><?php 
    esc_html_e( "Edit", 'easy-facebook-likebox' );
    ?></span><i class="material-icons right">edit</i></a>

                    <a class="btn waves-effect right efbl_skin_delete_free waves-light modal-trigger" href="#efbl-free-masonry-upgrade"><span><?php 
    esc_html_e( "Delete", 'easy-facebook-likebox' );
    ?></span><i class="material-icons right">delete_forever</i></a>

                    <a class="btn waves-effect efbl_copy_skin_id modal-trigger  waves-light" href="#efbl-free-masonry-upgrade"><?php 
    esc_html_e( "Copy Skin ID", 'easy-facebook-likebox' );
    ?><i class="material-icons right">content_copy</i></span> </a>
                </div>
    ...
    ?></p>
            ...
            <div class="card col efbl_single_skin efbl_single_skin_free s3">
                ...
                <div class="card-image waves-effect waves-block waves-light">
                    <a class=" modal-trigger" href="#efbl-free-carousel-upgrade"> <img class="" src="<?php 
    echo  FTA_PLUGIN_URL ;
    ?>admin/assets/images/skin-placeholder.jpg"> </a>
                </div>
                <div class="card-content">
                    <a class=" modal-trigger" href="#efbl-free-carousel-upgrade"> <span class="card-title  grey-text text-darken-4"><?php 
    ...
    ?>
                    ...
                    <a class="btn waves-effect  waves-light efbl_skin_redirect_free <?php 
    echo  $efbl_redirect_class ;
    ?> modal-trigger" href="#efbl-free-carousel-upgrade"><span><?php 
    esc_html_e( "Edit", 'easy-facebook-likebox' );
    ?></span><i class="material-icons right">edit</i></a>

                    <a class="btn waves-effect right efbl_skin_delete_free waves-light modal-trigger" href="#efbl-free-carousel-upgrade"><span><?php 
    esc_html_e( "Delete", 'easy-facebook-likebox' );
    ?></span><i class="material-icons right">delete_forever</i></a>

                    <a class="btn waves-effect efbl_copy_skin_id modal-trigger  waves-light" href="#efbl-free-carousel-upgrade"><?php 
    esc_html_e( "Copy Skin ID", 'easy-facebook-likebox' );
    ?><i class="material-icons right">content_copy</i></span> </a>
                </div>
