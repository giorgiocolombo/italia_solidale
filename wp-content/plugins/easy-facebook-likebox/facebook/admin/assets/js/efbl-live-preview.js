...
// console.log(efbl_skin_id);
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[show_next_prev_icon]', function( value ) {
		value.bind( function( newval ) {
			...
			if(newval){
				$('<style>html body .efbl_feed_wraper .efbl_feeds_carousel .owl-nav{display:flex!important}</style>').appendTo('head');
			
			}else
			{
			$('<style>html body .efbl_feed_wraper .efbl_feeds_carousel .owl-nav{display:none!important}</style>').appendTo('head');
			}
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[show_nav]', function( value ) {
		value.bind( function( newval ) {
			...
			if(newval){
				$('<style>.efbl_feed_wraper .owl-dots{display:block!important}</style>').appendTo('head');
			}else
			{
			$('<style>.efbl_feed_wraper .owl-dots{display:none!important}</style>').appendTo('head');
			}
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[load_more_background_color]', function( value ) {
		value.bind( function( newval ) {
			$( '.efbl_feed_wraper .efbl_load_more_holder a span' ).css('background-color', newval );
		});
	});
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[load_more_color]', function( value ) {
		value.bind( function( newval ) {
			$( '.efbl_feed_wraper .efbl_load_more_holder a span' ).css('color', newval );
		});
	});
	...
	*/
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[load_more_hover_background_color]', function( value ) {
		...
		value.bind( function( newval ) {
			$('<style>.efbl_feed_wraper .efbl_load_more_holder a:hover span{background-color:' + newval + '!important}</style>').appendTo('head');
	...
	*/
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[load_more_hover_color]', function( value ) {
		...
		value.bind( function( newval ) {
			$('<style>.efbl_feed_wraper .efbl_load_more_holder a:hover span{color:' + newval + '!important}</style>').appendTo('head');
	...
	*/	
	...
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_shadow_color]', function( value ) {

		value.bind( function( newval ) {

			$( '.efbl_feed_wraper .efbl-story-wrapper' ).css('box-shadow', '0 0 10px 0 '+newval+'' );

		} );

	} );

		wp.customize( 'efbl_skin_'+efbl_skin_id+'[header_shadow]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[header_shadow_color]', function( value ) {

		value.bind( function( newval ) {

			$( '.efbl_feed_wraper .efbl_header' ).css('box-shadow', '0 0 10px 0 '+newval+'' );
	...
	*/
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_content_padding]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_wraper .efbl-story-wrapper.grid .efbl_post_content, .efbl_feed_wraper .efbl-story-wrapper.grid .efbl_story_meta' ).css('padding', newval+'px' );
	...
	*/
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[header_dp_hover_icon_color]', function( value ) {
		...
		value.bind( function( newval ) {
			$('<style>.efbl_feed_wraper  .efbl_header .efbl_head_img_holder .efbl_overlay .icon{color:' + newval + '!important}</style>').appendTo('head');
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_background_color]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_wraper .efbl-story-wrapper, .efbl_feed_wraper .efbl_feeds_carousel .efbl-story-wrapper .efbl-grid-wrapper' ).css({"background-color": newval});
			
			
		});
	});

	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_borders_color]', function( value ) {

		value.bind( function( newval ) {

			$( '.efbl_feed_wraper .efbl-story-wrapper, .efbl_feed_wraper .efbl-story-wrapper .efbl-thumbnail-wrapper .efbl-thumbnail-col a img, .efbl_feed_wraper .efbl-story-wrapper .efbl-thumbnail-wrapper .efbl-thumbnail-col, .efbl_feed_wraper .efbl-story-wrapper .efbl-post-footer' ).css({"border-color": newval, "outline-color": newval});
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_shared_link_bg_color]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_wraper  .efbl-story-wrapper .efbl_shared_story' ).css({"background-color": newval});
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_shared_link_heading_color]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_wraper  .efbl-story-wrapper .efbl_shared_story .efbl_title_link a' ).css({"color": newval});
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_shared_link_color]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_wraper  .efbl-story-wrapper .efbl_shared_story .efbl_link_description' ).css({"color": newval});
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_shared_link_border_color]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_wraper  .efbl-story-wrapper .efbl_shared_story' ).css({"border-color": newval});
	...
	*/	
	...
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_spacing]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_wraper .efbl-story-wrapper' ).css({"margin-bottom": newval+'px'});
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_type_icon_color]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_wraper .efbl-story-wrapper .efbl-overlay .efbl_multimedia, .efbl_feed_wraper .efbl-story-wrapper .efbl-overlay .icon-esf-video-camera' ).css({"color": newval});
			
			
		});
	});

	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_meta_buttons_color]', function( value ) {

		value.bind( function( newval ) {

			$( '.efbl_feed_wraper .efbl-story-wrapper .efbl-post-footer .efbl-view-on-fb, .efbl_feed_wraper .efbl-story-wrapper .efbl-post-footer .esf-share-wrapper .esf-share' ).css({"color": newval});
			
			
		});
	});

	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_meta_buttons_bg_color]', function( value ) {

		value.bind( function( newval ) {

			$( '.efbl_feed_wraper .efbl-story-wrapper .efbl-post-footer .efbl-view-on-fb, .efbl_feed_wraper .efbl-story-wrapper .efbl-post-footer .esf-share-wrapper .esf-share' ).css({"background": newval});
			
			
		});
	});

	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_meta_buttons_hover_bg_color]', function( value ) {
		value.bind( function( newval ) {
			$('<style>.efbl_feed_wraper .efbl-story-wrapper .efbl-post-footer .efbl-view-on-fb:hover, .efbl_feed_wraper .efbl-story-wrapper .efbl-post-footer .esf-share-wrapper .esf-share:hover{background:' + newval + '!important}</style>').appendTo('head');
		});
	});

	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_meta_buttons_hover_color]', function( value ) {
		value.bind( function( newval ) {
			$('<style>.efbl_feed_wraper .efbl-story-wrapper .efbl-post-footer .efbl-view-on-fb:hover, .efbl_feed_wraper .efbl-story-wrapper .efbl-post-footer .esf-share-wrapper .esf-share:hover{color:' + newval + '!important}</style>').appendTo('head');
		});
	});

	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_hover_shadow_color]', function( value ) {

		value.bind( function( newval ) {

			$( '.efbl_feed_wraper .efbl-story-wrapper .efbl-overlay' ).css({"background": newval});
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_header]', function( value ) {
		value.bind( function( newval ) {
			...
			if(newval){
				$( '.efbl_feed_wraper  .efbl-story-wrapper .efbl_author_info ' ).fadeIn('slow');
			}else
			{
			$( '.efbl_feed_wraper .efbl-story-wrapper .efbl_author_info ' ).fadeOut('slow');
			}
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_shared_link]', function( value ) {
		value.bind( function( newval ) {
			...
			if(newval){
				$( '.efbl_feed_wraper  .efbl-story-wrapper .efbl_shared_story' ).fadeIn('slow');
			}else
			{
			$( '.efbl_feed_wraper  .efbl-story-wrapper .efbl_shared_story' ).fadeOut('slow');
			}
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_header_logo]', function( value ) {
		value.bind( function( newval ) {
			...
			if(newval){
				$( '.efbl_feed_wraper  .efbl-story-wrapper .efbl_author_info .efbl_auth_logo' ).fadeIn('slow');
			}else
			{
			$( '.efbl_feed_wraper  .efbl-story-wrapper .efbl_author_info .efbl_auth_logo' ).fadeOut('slow');
			}
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[number_of_cols]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_wraper .efbl-grid-skin .efbl-row.e-outer' ).css({"grid-template-columns": 'repeat(auto-fill, minmax('+no_of_columns+'%, 1fr))'});
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_padding_bottom]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_wraper  .efbl-story-wrapper' ).css({"padding-bottom": newval+'px'});
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_padding_top]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_wraper  .efbl-story-wrapper' ).css({"padding-top": newval+'px'});
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_padding_right]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_wraper  .efbl-story-wrapper' ).css({"padding-right": newval+'px'});
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_padding_left]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_wraper  .efbl-story-wrapper' ).css({"padding-left": newval+'px'});
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_margin_top]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_wraper  .efbl-story-wrapper' ).css({"margin-top": newval+'px'});
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_margin_left]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_wraper  .efbl-story-wrapper' ).css({"margin-left": newval+'px'});
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_margin_right]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_wraper  .efbl-story-wrapper' ).css({ "margin-right": newval+'px'});
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_meta_data_color]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_wraper .efbl-post-footer .efbl-reacted-item, .efbl_feed_wraper .efbl-post-footer .efbl-reacted-item .efbl_all_comments_wrap' ).css({"color": newval});
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_comments_color]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_wraper .efbl_comments' ).fadeOut('slow');
			$( '.efbl_feed_wraper .efbl_comments' ).fadeOut('slow');
			$( '.efbl_feed_wraper  .efbl_comments p, .efbl_feed_wraper .efbl_comments .icon' ).css({"color": newval});
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_cta_text_hover_color]', function( value ) {
		value.bind( function( newval ) {
			$('<style>.efbl_feed_wraper .efbl-story-wrapper .efbl_read_more_link a:hover{color:' + newval + '!important}</style>').appendTo('head');
		});
	});
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_seprator_color]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_wraper .efbl-story-wrapper' ).css({"border-color": newval});
	...
	*/
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_border_style]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_wraper  .efbl-story-wrapper' ).css('border-style', newval );
	...
	*/
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[feed_border_size]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_wraper  .efbl-story-wrapper' ).css('border-width', newval+'px' );
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[popup_sidebar_bg]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_popup_container .efbl-post-detail .efbl-d-columns-wrapper' ).css({"background": newval});
			
			$('<style>.efbl_feed_popup_container .efbl-post-detail .efbl-d-columns-wrapper .efbl-caption::after{background:' + newval + '}</style>').appendTo('head');
		});
	});	
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[popup_sidebar_color]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_popup_container .efbl-post-detail .efbl-d-columns-wrapper, .efbl_feed_popup_container .efbl-post-detail .efbl-d-columns-wrapper .efbl-caption .efbl-feed-description, .efbl_feed_popup_container .efbl-post-detail a, .efbl_feed_popup_container .efbl-post-detail span' ).css({"color": newval});
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[popup_show_header]', function( value ) {
		value.bind( function( newval ) {
			...
			if(newval){
				$('<style>.efbl_feed_popup_container .efbl-post-detail .efbl-d-columns-wrapper .efbl-post-header{display:flex!important}</style>').appendTo('head');
			}else
			{
			$('<style>.efbl_feed_popup_container .efbl-post-detail .efbl-d-columns-wrapper .efbl-post-header{display:none!important}</style>').appendTo('head');
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[popup_show_header_logo]', function( value ) {
		value.bind( function( newval ) {
			...
			if(newval){
				$( '.efbl_feed_popup_container .efbl-post-detail .efbl-d-columns-wrapper .efbl-post-header .efbl-profile-image' ).fadeIn('slow');
			}else
			{
			$( '.efbl_feed_popup_container .efbl-post-detail .efbl-d-columns-wrapper .efbl-post-header .efbl-profile-image' ).fadeOut('slow');
			}
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[popup_header_title_color]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_popup_container .efbl-post-detail .efbl-d-columns-wrapper .efbl-post-header h2' ).css({"color": newval});
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[popup_post_time_color]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_popup_container .efbl-post-detail .efbl-d-columns-wrapper .efbl-post-header span' ).css({"color": newval});
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[popup_show_caption]', function( value ) {
		value.bind( function( newval ) {
			...
			if(newval){
				$( '.efbl_feed_popup_container .efbl-feed-description, .efbl_feed_popup_container .efbl_link_text' ).fadeIn('slow');
			}else
			{
			$( '.efbl_feed_popup_container .efbl-feed-description, .efbl_feed_popup_container .efbl_link_text' ).fadeOut('slow');
			}
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[popup_show_meta]', function( value ) {
		value.bind( function( newval ) {
			...
			if(newval){
				$('<style>.efbl_feed_popup_container .efbl-post-detail .efbl-d-columns-wrapper .efbl-reactions-box{display:flex!important}</style>').appendTo('head');
			}else
			{
			   $('<style>.efbl_feed_popup_container .efbl-post-detail .efbl-d-columns-wrapper .efbl-reactions-box{display:none!important}</style>').appendTo('head');
			}
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[popup_meta_color]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_popup_container .efbl-post-detail .efbl-d-columns-wrapper .efbl-reactions-box .efbl-reactions span' ).css({"color": newval});
			
			
		});
	});

	wp.customize( 'efbl_skin_'+efbl_skin_id+'[popup_meta_border_color]', function( value ) {

		value.bind( function( newval ) {

			$( '.efbl_feed_popup_container .efbl-post-detail .efbl-d-columns-wrapper .efbl-reactions-box' ).css({"border-color": newval});
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[popup_show_reactions_counter]', function( value ) {
		value.bind( function( newval ) {
			...
			if(newval){
				$('<style>.efbl_feed_popup_container .efbl-post-detail .efbl-d-columns-wrapper .efbl-reactions-box .efbl-reactions .efbl_popup_likes_main{display:flex!important}</style>').appendTo('head');
			}else
			{
				$('<style>.efbl_feed_popup_container .efbl-post-detail .efbl-d-columns-wrapper .efbl-reactions-box .efbl-reactions .efbl_popup_likes_main{display:none!important}</style>').appendTo('head');
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[popup_show_comments_counter]', function( value ) {
		value.bind( function( newval ) {
			...
			if(newval){
				$('<style>.efbl_feed_popup_container .efbl-post-detail .efbl-d-columns-wrapper .efbl-reactions-box .efbl-reactions .efbl-popup-comments-icon-wrapper{display:flex!important}</style>').appendTo('head');
			}else
			{
			$('<style>.efbl_feed_popup_container .efbl-post-detail .efbl-d-columns-wrapper .efbl-reactions-box .efbl-reactions .efbl-popup-comments-icon-wrapper{display:none!important}</style>').appendTo('head');
			}
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[popup_show_comments]', function( value ) {
		value.bind( function( newval ) {
			...
			if(newval){
				$( '.efbl_feed_popup_container .efbl-commnets, .efbl_feed_popup_container .efbl-comments-list' ).fadeIn('slow');
			}else
			{
			$( '.efbl_feed_popup_container .efbl-commnets, .efbl_feed_popup_container .efbl-comments-list' ).fadeOut('slow');
			}
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[popup_comments_color]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.efbl_feed_popup_container .efbl-post-detail .efbl-d-columns-wrapper .efbl-comments-list .efbl-comment-wrap' ).css({"color": newval});
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[popup_show_close_icon]', function( value ) {
		value.bind( function( newval ) {
			...
			if(newval){
				$( '.fancybox-container .efbl_feed_popup_container.fancybox-content .fancybox-close-small' ).fadeIn('slow');
			}else
			{
			$( '.fancybox-container .efbl_feed_popup_container.fancybox-content .fancybox-close-small' ).fadeOut('slow');
			}
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[popup_close_icon_bg_color]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.fancybox-container .efbl_feed_popup_container.fancybox-content .fancybox-close-small' ).css({"background-color": newval});
	...
	*/	
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[popup_close_icon_color]', function( value ) {
		...
		value.bind( function( newval ) {
			...
			$( '.fancybox-container .efbl_feed_popup_container.fancybox-content .fancybox-close-small' ).css({"color": newval});
	...
	*/
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[popup_close_icon_bg_hover_color]', function( value ) {
		...
		value.bind( function( newval ) {
			$('<style>.fancybox-container .efbl_feed_popup_container.fancybox-content .fancybox-close-small:hover{background-color:' + newval + '!important}</style>').appendTo('head');
	...
	*/
	wp.customize( 'efbl_skin_'+efbl_skin_id+'[popup_close_icon_hover_color]', function( value ) {
		...
		value.bind( function( newval ) {
			$('<style>.fancybox-container .efbl_feed_popup_container.fancybox-content .fancybox-close-small:hover{color:' + newval + '!important}</style>').appendTo('head');
