          ...
          <div class="esf_wc_boxes_wrap">
            <div class="esf_wc_box">
              ...
              <div class="esf_wc_box_content">
                ...
                <div class="esf_wc_box_btns_holder">
                  <a class="waves-effect waves-light btn" href="<?php echo esc_url( admin_url('admin.php?page=easy-facebook-likebox&sub_tab=efbl-likebox-use#efbl-general') );?>">
            ...
            <div class="esf_wc_box">
              ...
              <div class="esf_wc_box_content">
                ...
                <div class="esf_wc_box_btns_holder">
                  <a class="waves-effect waves-light btn" href="<?php echo esc_url( admin_url('admin.php?page=easy-facebook-likebox') ) ?>">
                    <?php esc_html_e("Use this feature", 'easy-facebook-likebox');?>
                  </a>
                </div>
              </div>
            ...
            <div class="esf_wc_box">
              ...
              <div class="esf_wc_box_content">
               <h5><?php esc_html_e("Custom Instagram Feed", 'easy-facebook-likebox');?></h5>
                ...
                <div class="esf_wc_box_btns_holder">
                  <a class="waves-effect waves-light btn" href="<?php echo esc_url( admin_url('admin.php?page=mif') ) ?>">
                    <?php esc_html_e("Use this feature", 'easy-facebook-likebox');?>
                    </a>
                </div>
              </div>
