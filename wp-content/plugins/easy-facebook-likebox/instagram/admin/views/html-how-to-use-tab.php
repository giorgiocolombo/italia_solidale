...
if ( isset( $fta_settings['plugins']['facebook']['approved_pages'] ) && !empty($fta_settings['plugins']['facebook']['approved_pages']) || esf_insta_instagram_type() == 'personal' ) {
    ...
    ?></p>
                <blockquote class="mif-shortcode-block">[my-instagram-feed user_id="<?php 
    echo  esf_insta_default_id() ;
    ?>" skin_id="<?php 
    echo  $fta_settings['plugins']['instagram']['default_skin_id'] ;
    ?>"] </blockquote> 
                <a class="btn waves-effect mif_copy_shortcode waves-light tooltipped" data-position="right" data-delay="50" data-tooltip="<?php 
    esc_html_e( "Copy", 'easy-facebook-likebox' );
    ?>" data-clipboard-text='[my-instagram-feed user_id="<?php 
    echo  esf_insta_default_id() ;
    ?>" skin_id="<?php 
    echo  $fta_settings['plugins']['instagram']['default_skin_id'] ;
    ?>"]' href="javascript:void(0);"><i class="material-icons right">content_copy</i> </a>
...
if ( efl_fs()->is_plan( 'instagram_premium', true ) or efl_fs()->is_plan( 'combo_premium', true ) ) {
    ...
    <span class="form_fields col s12">
        <input name="" class="modal-trigger" href="#esf-insta-hashtag-upgrade" type="checkbox" id="esf-insta-free-hashtag" />
        <label for="esf-insta-free-hashtag"><?php 
    esc_html_e( "Hashtag", 'easy-facebook-likebox' );
    ?></label>
    </span> 

    <div id="esf-insta-hashtag-upgrade" class="fta-upgrade-modal modal">
...
if ( efl_fs()->is_plan( 'instagram_premium', true ) or efl_fs()->is_plan( 'combo_premium', true ) ) {
    ...
    esc_html_e( "Skin - Masonry", 'easy-facebook-likebox' );
    ?></option>
            <option value="free-carousel"><?php 
    esc_html_e( "Skin - Carousel", 'easy-facebook-likebox' );
    ?></option>
            <option value="free-half_width"><?php 
    esc_html_e( "Skin - Half Width", 'easy-facebook-likebox' );
    ?></option>
            <option value="free-full_width"><?php 
    esc_html_e( "Skin - Full Width", 'easy-facebook-likebox' );
    ?></option>
       <?php 
}
...
?></label>
    ...
    <div class="input-field col s6 mif_fields"> 
        <input id="mif_feeds_per_page" type="number" value="9" min="1">
        <label for="mif_feeds_per_page"  class=""><?php 
esc_html_e( "Feeds Per Page", 'easy-facebook-likebox' );
?></label>
    </div>
                    
<div class="input-field col s6 mif_fields">
    <input id="mif_caption_words" type="number" value="25" min="1">
    <label for="mif_caption_words" class=""><?php 
...
<div class="input-field col s6 mif_fields">
    <input id="mif_cache_unit" type="number" value="1" min="1">
    <label for="mif_cache_unit" class=""><?php 
...
<div class="input-field col s12 mif_fields">
    ...
    <label for="mif_wrap_class" class=""><?php 
esc_html_e( "Wrapper Class", 'easy-facebook-likebox' );
?></label>
</div>

<input type="submit" class="btn  mif_shortcode_submit" value="<?php 
...
<div class="mif_generated_shortcode">
   ...
   <a class="btn waves-effect mif_copy_shortcode mif_shortcode_generated_final waves-light tooltipped" data-position="right" data-delay="50" data-tooltip="<?php 
esc_html_e( "Copy", 'easy-facebook-likebox' );
?>"  href="javascript:void(0);"><i class="material-icons right">content_copy</i> </a>
</div> 
</div>  
