...
?></a>
  ...
  <a class="btn waves-effect mif_create_skin waves-light" href="javascript:void(0);"><?php 
...
?> <i class="material-icons left">add_circle_outline</i></a>
  ...
  <div class="mif_new_skin col s12">  
    <form name="mif_new_skin_details" id="mif_new_skin_details">
     <a class="waves-effect waves-light mif_show_all_skins btn" href="javascript:void(0);"><?php 
...
?> <i class="material-icons left">list</i></a>
     <div class="input-field">
      ...
      <label for="mif_skin_title" class=""><?php 
...
?></label>
    ...
    <div class="input-field">
      ...
      <label for="mif_skin_description" class=""><?php 
...
?></label>
    ...
    <div class="input-field">
      ...
      <div class="mdl-textfield mdl-js-textfield mif_skin_feat_img_wrap">
       ...
       <input class="mdl-textfield__input" type="text" id="mif_skin_feat_img" placeholder="<?php 
...
?>" value="" name="mif_skin_feat_img">
       ...
       <i class="btn waves-effect waves-light waves-input-wrapper">
        <input type="button" class="" value="<?php 
...
<label for="mif_selected_layout" class=""><?php 
...
<label for="mif_skin_selected" class=""><?php 
...
<i class="btn waves-effect create_new_skin_fb_wrap waves-light waves-input-wrapper">
 <input type="submit" class="create_new_skin_sub" name="create_new_skin_sub" value="<?php 
...
if ( $mif_skins ) {
    ...
    <a class="btn waves-effect right esf_insta_skin_delete_confrim waves-light" data-skin_id="<?php 
        echo  $mif_skin['ID'] ;
        ?>" href="javascript:void(0);"><span><?php 
        esc_html_e( "Delete", 'easy-facebook-likebox' );
        ?></span><i class="material-icons right">delete_forever</i></a>

    <a class="btn waves-effect esf_insta_copy_skin_id waves-light"  data-clipboard-text="<?php 
        echo  $mif_skin['ID'] ;
        ?>" href="javascript:void(0);"><?php 
        esc_html_e( "Copy Skin ID", 'easy-facebook-likebox' );
        ?><i class="material-icons right">content_copy</i></span> </a>
  </div>
...
if ( efl_fs()->is_plan( 'instagram_premium', true ) or efl_fs()->is_plan( 'combo_premium', true ) ) {
  ...
  <div class="card col mif_single_skin mif_single_skin_free s3">
    ...
    <div class="card-image waves-effect waves-block waves-light">
     <a class=" modal-trigger" href="#mif-free-masonry-upgrade"> <img class="" src="<?php 
    echo  FTA_PLUGIN_URL ;
    ?>admin/assets/images/skin-placeholder.jpg"> </a>
   </div>
   <div class="card-content">
     <a class=" modal-trigger" href="#mif-free-masonry-upgrade"> <span class="card-title  grey-text text-darken-4"><?php 
    esc_html_e( "Skin - Masonry layout", 'easy-facebook-likebox' );
    ?><i class="material-icons right">more_vert</i></span> </a>
   </div>
   <span class="selected_layout"><?php 
...
<a class="btn waves-effect  waves-light esf_insta_skin_redirect_free  modal-trigger" href="#mif-free-masonry-upgrade"><span><?php 
    esc_html_e( "Edit", 'easy-facebook-likebox' );
    ?></span><i class="material-icons right">edit</i></a>

<a class="btn waves-effect right esf_insta_skin_delete_free waves-light modal-trigger" href="#mif-free-masonry-upgrade"><span><?php 
    esc_html_e( "Delete", 'easy-facebook-likebox' );
    ?></span><i class="material-icons right">delete_forever</i></a>

<a class="btn waves-effect esf_insta_copy_skin_id modal-trigger  waves-light" href="#mif-free-masonry-upgrade"><?php 
    esc_html_e( "Copy Skin ID", 'easy-facebook-likebox' );
    ?><i class="material-icons right">content_copy</i></span> </a>
</div>
...
<div class="card col mif_single_skin mif_single_skin_free s3">
  ...
  <div class="card-image waves-effect waves-block waves-light">
   <a class=" modal-trigger" href="#mif-free-carousel-upgrade"> <img class="" src="<?php 
    echo  FTA_PLUGIN_URL ;
    ?>admin/assets/images/skin-placeholder.jpg"> </a>
 </div>
 <div class="card-content">
   <a class=" modal-trigger" href="#mif-free-carousel-upgrade"> <span class="card-title  grey-text text-darken-4"><?php 
...
<a class="btn waves-effect  waves-light esf_insta_skin_redirect_free modal-trigger" href="#mif-free-carousel-upgrade"><span><?php 
    esc_html_e( "Edit", 'easy-facebook-likebox' );
    ?></span><i class="material-icons right">edit</i></a>

<a class="btn waves-effect right esf_insta_skin_delete_free waves-light modal-trigger" href="#mif-free-carousel-upgrade"><span><?php 
    esc_html_e( "Delete", 'easy-facebook-likebox' );
    ?></span><i class="material-icons right">delete_forever</i></a>

<a class="btn waves-effect esf_insta_copy_skin_id modal-trigger  waves-light" href="#mif-free-carousel-upgrade"><?php 
    esc_html_e( "Copy Skin ID", 'easy-facebook-likebox' );
    ?><i class="material-icons right">content_copy</i></span> </a>
</div>
...
<div class="card col mif_single_skin mif_single_skin_free s3">
  ...
  <div class="card-image waves-effect waves-block waves-light">
   <a class=" modal-trigger" href="#mif-free-half_width-upgrade"> <img class="" src="<?php 
    echo  FTA_PLUGIN_URL ;
    ?>admin/assets/images/skin-placeholder.jpg"> </a>
 </div>
 <div class="card-content">
   <a class=" modal-trigger" href="#mif-free-half_width-upgrade"> <span class="card-title  grey-text text-darken-4"><?php 
...
<a class="btn waves-effect  waves-light esf_insta_skin_redirect_free modal-trigger" href="#mif-free-half_width-upgrade"><span><?php 
    esc_html_e( "Edit", 'easy-facebook-likebox' );
    ?></span><i class="material-icons right">edit</i></a>

<a class="btn waves-effect right esf_insta_skin_delete_free waves-light modal-trigger" href="#mif-free-half_width-upgrade"><span><?php 
    esc_html_e( "Delete", 'easy-facebook-likebox' );
    ?></span><i class="material-icons right">delete_forever</i></a>

<a class="btn waves-effect esf_insta_copy_skin_id modal-trigger  waves-light" href="#mif-free-half_width-upgrade"><?php 
    esc_html_e( "Copy Skin ID", 'easy-facebook-likebox' );
    ?><i class="material-icons right">content_copy</i></span> </a>
</div>
...
<div class="card col mif_single_skin mif_single_skin_free s3">
  ...
  <div class="card-image waves-effect waves-block waves-light">
   <a class=" modal-trigger" href="#mif-free-full_width-upgrade"> <img class="" src="<?php 
    echo  FTA_PLUGIN_URL ;
    ?>admin/assets/images/skin-placeholder.jpg"> </a>
 </div>
 <div class="card-content">
   <a class=" modal-trigger" href="#mif-free-full_width-upgrade"> <span class="card-title  grey-text text-darken-4"><?php 
...
<a class="btn waves-effect  waves-light esf_insta_skin_redirect_free modal-trigger" href="#mif-free-full_width-upgrade"><span><?php 
    esc_html_e( "Edit", 'easy-facebook-likebox' );
    ?></span><i class="material-icons right">edit</i></a>

<a class="btn waves-effect right esf_insta_skin_delete_free waves-light modal-trigger" href="#mif-free-full_width-upgrade"><span><?php 
    esc_html_e( "Delete", 'easy-facebook-likebox' );
    ?></span><i class="material-icons right">delete_forever</i></a>

<a class="btn waves-effect esf_insta_copy_skin_id modal-trigger  waves-light" href="#mif-free-full_width-upgrade"><?php 
    esc_html_e( "Copy Skin ID", 'easy-facebook-likebox' );
    ?><i class="material-icons right">content_copy</i></span> </a>
</div>
...
?></p>
      <a class="waves-effect waves-light btn modal-close" href="javascript:void(0)"><?php 
esc_html_e( "Cancel", 'easy-facebook-likebox' );
?></a>
      <a class="waves-effect waves-light btn esf_insta_skin_delete modal-close" href="javascript:void(0)"><?php 
esc_html_e( "Delete", 'easy-facebook-likebox' );
?></a>
    </div>
  </div>
