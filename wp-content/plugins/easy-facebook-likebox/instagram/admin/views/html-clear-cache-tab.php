    ...
    <p><?php esc_html_e("Following are the feeds cached data from Instagram API. Delete the cache to refresh your feeds manually", 'easy-facebook-likebox');?></p>
        ...
        if ( $mif_trans_bio ) { ?>
            ...
            <ul class="collection with-header mif_bio_collection">
                <li class="collection-header"><h5><?php esc_html_e("Profile Bio", 'easy-facebook-likebox');?></h5></li>
                ...
                <?php foreach ( $mif_trans_bio as $key => $value ) {
                    ...
                    <li class="collection-item <?php echo $key; ?>">
                        ...
                        <a href="javascript:void(0);" data-mif_collection="mif_bio_collection" data-mif_trans="<?php echo $key; ?>" class="secondary-content mif_del_trans"><i class="material-icons">delete</i></a>
                    </div>
                </li>
            <?php } ?>
    ...
    if ( $mif_trans_posts ) { ?>
        ...
        <ul class="collection with-header mif_users_collection">
            ...
            <?php foreach ( $mif_trans_posts as $key => $value ) {
                ...
                <li class="collection-item <?php echo $key; ?>">
                    <div><?php echo $trans_name; ?>
                    <a href="javascript:void(0);" data-mif_collection="mif_users_collection" data-mif_trans="<?php echo $key; ?>" class="secondary-content mif_del_trans"><i class="material-icons">delete</i></a>
                </div>
            </li>
        <?php    } ?>
    </ul>
