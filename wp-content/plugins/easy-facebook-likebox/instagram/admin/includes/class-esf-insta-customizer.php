    ...
    class ESF_Insta_Customizer
    {
        ...
        public function esf_insta_customizer( $wp_customize )
        {
            ...
            $wp_customize->add_panel( 'mif_customize_panel', array(
                'title' => __( 'Easy Instagram Feed', $Feed_Them_All->plug_slug ),
            ) );
            //======================================================================
            // Layout section
            //======================================================================
            ...
            if ( 'half_width' == $selected_layout || 'full_width' == $selected_layout ) {
                ...
                $wp_customize->add_control( $setting, array(
                    'label'    => __( 'Show Or Hide Likes Counter', $Feed_Them_All->plug_slug ),
                    'section'  => 'mif_feed',
                    'settings' => $setting,
                    'type'     => 'checkbox',
                ) );
                ...
                $wp_customize->add_control( $setting, array(
                    'label'    => __( 'Show Or Hide Comments Counter', $Feed_Them_All->plug_slug ),
                    'section'  => 'mif_feed',
                    'settings' => $setting,
                    'type'     => 'checkbox',
                ) );
