...
?>
	...
	<div class="esf_insta_header">
		<div class="esf_insta_header_inner_wrap">
				...
				<?php if ( $esf_insta_user_data->profile_picture_url && $mif_values['show_dp'] ){  ?>

					<div class="esf_insta_header_img">
						<a href="<?php echo esc_url_raw( $this->instagram_url ); ?>/<?php echo sanitize_text_field( $mif_self_username ); ?>" title="@<?php echo sanitize_text_field( $mif_self_name ); ?>" target="_blank">
							...
							<?php if ( $mif_instagram_type !== 'personal' ) { 
								...
								<img src="<?php echo esc_url( apply_filters( 'esf_insta_feed_header_image', $esf_insta_user_data->profile_picture_url, $esf_insta_user_data ) ) ; ?>" />

								<?php if( $hashtag && !empty( $hashtag) ){ ?>

									<span class="esf-insta-hashtag-overlay"><i class="icon icon-esf-instagram"></i></span>
									
								<?php } ?>	

							<?php do_action('esf_insta_after_feed_header_image', $esf_insta_user_data);
			...
			<div class="esf_insta_header_content">
				<div class="esf_insta_header_meta">
					...
					<?php if ( $mif_self_name ) { ?>
						...
						<div class="esf_insta_header_title">
							...
							<?php do_action('esf_insta_before_feed_header_title', $esf_insta_user_data); ?>

							<h4>
								<a href="<?php echo esc_url_raw( $this->instagram_url ); ?>/<?php echo sanitize_text_field( $mif_self_username ); ?>" title="@<?php echo sanitize_text_field( $mif_self_username ); ?>" target="_blank">
								<?php echo $mif_self_name; ?>
								</a>
							</h4>
							
							<?php do_action('esf_insta_after_feed_header_title', $esf_insta_user_data); ?>
					...
					<?php if ( $mif_instagram_type !== 'personal' && isset( $esf_insta_user_data->followers_count ) && $esf_insta_user_data->followers_count > 0 && !$hashtag ) {
						...
						<div class="esf_insta_followers" title="<?php echo __('Followers', 'easy-facebook-likebox'); ?>">

							<?php do_action('esf_insta_before_feed_header_followers', $esf_insta_user_data); ?>

							<i class="icon icon-esf-user" aria-hidden="true"></i><?php echo esf_insta_readable_count( apply_filters( 'esf_insta_feed_header_followers', $esf_insta_user_data->followers_count, $esf_insta_user_data ) ); ?>

							<?php do_action('esf_insta_after_feed_header_followers', $esf_insta_user_data); ?>
						</div>
				...
				<?php do_action('esf_insta_after_feed_header_bio', $esf_insta_user_data);
...
<?php do_action('esf_insta_after_feed_header', $esf_insta_user_data);
