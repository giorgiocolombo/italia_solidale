  ...
  <div class="esf-insta-d-flex esf-insta-justify-content-between">
    ...
    <div class="esf-insta-view-share esf-insta-d-flex esf-insta-justify-content-between esf-insta-align-items-center esf-insta-mb-1 esf-insta-mt-1">
      ...
      <?php if( $mif_values['show_feed_view_on_instagram'] ){ ?>
        ...
        <a href="<?php echo esc_url( $feed->permalink ); ?>" target="_blank" class="esf-insta-view-on-fb no-anchor-style link esf-insta-mr-1">
      ...
      <div class="esf-share-wrapper">
        <button class="no-anchor-style link esf-share"><?php echo __('Share', 'easy-facebook-likebox') ?></button>
        <div class="esf-social-share">
          <button>
            <a class="esf_insta_facebook" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo esc_url( $feed->permalink ); ?>" target="_blank">
              <i class="icon icon-esf-facebook"></i>
            </a>
          </button>

          <button>
            <a class="esf_insta_twitter" href="https://twitter.com/intent/tweet?text=<?php echo esc_url( $feed->permalink ); ?>" target="_blank">
              <i class="icon icon-esf-twitter"></i>
            </a>
          </button>

          <button>
            <a class="esf_insta_linked_in" href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo esc_url( $feed->permalink ); ?>" target="_blank">
